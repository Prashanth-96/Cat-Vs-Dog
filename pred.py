...
os.chdir("/uploads") #creating a folder in the directory to store images to classify,which will be deleted after classifying.
...
model=keras.models.load_model("/Trained Model") #specify the directory where the model is present
